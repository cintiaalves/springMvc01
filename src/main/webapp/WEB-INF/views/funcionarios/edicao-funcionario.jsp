...
<body>
	...
	<c:if test="${not empty mensagem_sucesso}">
		<div class="alert alert-success alert-dismissiblefade show"
			role="alert">
	...
	<c:if test="${not empty mensagem_erro}">
		<div class="alert alert-danger alert-dismissiblefade show"
			role="alert">
	...
	<div class="container mt-4">
		...
		<a href="/springMvc01/listagemFuncionarios" class="btn btn-light">Voltar
			para a consulta</a>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<form id="formCadastro" method="post" action="atualizarFuncionario">
					...
					<!--  campo oculto para armazenar o id do funcionario -->
					...
					<div class="mb-3">
						<label>CPF:</label>
						<form:input path="funcionario.cpf" type="text" id="cpf" 
							name="cpf" class="form-control" placeholder="Ex: 999.999.999-99"
							autocomplete="off" />
					</div>
					
					<div class="mb-3">
						<label>Matrícula:</label>
						<form:input path="funcionario.matricula" type="text" id="matricula" 
							name="matricula" class="form-control" placeholder="Ex: 9999-999" 
							autocomplete="off" />
					</div>
					...
					<div class="mb-3">
						...
						<form:select path="funcionario.situacao" id="situacao" name="situacao" class="form-select">
							<form:options items="${situacoes}"/>
						</form:select>
					</div>
					
					<div>
						<button type="submit" class="btn btn-primary">AtualizarFuncionário</button>
					</div>

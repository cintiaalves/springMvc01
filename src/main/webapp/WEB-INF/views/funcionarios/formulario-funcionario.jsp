	...
	<div class="container mt-4">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<form id="formCadastro" method="post" action="cadastrarFuncionario">
			...
			$("#formCadastro").validate({
				...
				rules : {
					...
					'cpf' : {
						...
						maxlength : 14 //máximo de caracteres
					},
					'matricula' : {
						required : true, //campo obrigatório
						minlength : 8, //minimo de caracteres
						maxlength : 8 //máximo de caracteres
					},
					'salario' : {
						required : true, //campo obrigatório
						number : true //tipo numérico
					},
					'situacao' : {
						required : true //campo obrigatório
					}

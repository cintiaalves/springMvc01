...
<body>
	...
	<div class="container mt-4">
		...
		<table id="tabelaFuncionarios"
			...
			<thead>
				<tr>
					<!-- tr é linha, th é como título das colunas, thead é o cabeçalho da tabela -->
			...
			<tbody>
				<c:forEach var="f" items="${listafuncionarios}">
					...
					<tr>
						...
						<td>
							<a href="edicaoFuncionario?id=${f.idFuncionario}" class="btn btn-primary btn-sm"> Alterar </a> 
							<a href="excluirFuncionario?id=${f.idFuncionario}" class="btn btn-danger btn-sm" onclick="return window.confirm('Deseja realmente excluir este funcionário?');"> Excluir </a>
						</td>
